...
export class FactoryService<Entity, Settings> {
     ...
     * 构造函数
     *
     * @param {string} name Entity类名
     * @param {ObjectType<Entity>} entity Entity类
     * @param {EntityManager} em
     * @param {DbFactoryHandler<Entity, Settings>} factory Factory处理器
     * @param {Settings} [settings] 自定义设置
